...
{        
	...
	PORTE_PCR6=(0|PORT_PCR_MUX(1));//LCD_DC
	PORTE_PCR0=(0|PORT_PCR_MUX(1)); //LCD_SCL
	PORTE_PCR2=(0|PORT_PCR_MUX(1));//LCD_SDA
	PORTE_PCR4=(0|PORT_PCR_MUX(1));//LCD_RST 
	
	//设置GPIOD pin14,pin15为输出方向
	GPIOE_PDDR=GPIO_PDDR_PDD(GPIO_PIN(0)|GPIO_PIN(2)|GPIO_PIN(4)|GPIO_PIN(6));	
