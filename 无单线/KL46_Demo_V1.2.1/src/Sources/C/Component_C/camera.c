...
u8 Pic_Buffer[ROW][COLUMN] = {0};//图像缓冲区
u8 complete_flag = 0;
u8 temp_row = 0;
u8 temp_counter= 0;
...
{
  //DMA init
  DMA_PORTx2BUFF_Init(DMA_CH0,(uint32)&GPIOD_PDIR,Pic_Buffer, TRIGER_PORT,DMA_BYTE1,COLUMN, DMA_REQ_M2);  
}
